...
// State: Bit7=T Bit6=T Bit5=P Bit4=P Bit3=P Bit2=0 Bit1=0 Bit0=T 
...
// Output Pulse(s):
// OC1A Period: 16.368 ms Width: 12.272 ms// OC1B Period: 16.368 ms Width: 0 us
...
while (1)
      {   
          ...
          if(PINC.0 == 0)
          {  
            // button 1 to increase the value of motor speed by 100
            pwmValue = pwmValue + 100;
            buttonCounter++;
          }
          else if(PINC.1 == 0)
          {
          // button 1 to decrease the value of motor speed by 100
            pwmValue = pwmValue - 100;
            buttonCounter++;
          }
          ...
          if(buttonCounter == 10)
          {
            // sent the latest value of speed
            sentLog(pwmValue);
          }
      }
}
