...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _pwmValue=R3
	.DEF _pwmValue_msb=R4
	.DEF _buttonCounter=R5
	.DEF _buttonCounter_msb=R6
...
; 0000 0055 // OC1A Period: 16.368 ms Width: 12.272 ms// OC1B Period: 16.368 ms Width: 0 us
...
_0x3:
; 0000 00A2       {
; 0000 00A3           if(PINC.0 == 0)
	SBIC 0x6,0
	RJMP _0x6
; 0000 00A4           {
; 0000 00A5             pwmValue = pwmValue + 100;
	__GETW1R 3,4
	SUBI R30,LOW(-100)
	SBCI R31,HIGH(-100)
	__PUTW1R 3,4
; 0000 00A6             buttonCounter++;
	RJMP _0xF
; 0000 00A7           }
; 0000 00A8           else if(PINC.1 == 0)
_0x6:
	SBIC 0x6,1
	RJMP _0x8
; 0000 00A9           {
; 0000 00AA             pwmValue = pwmValue - 100;
	LDI  R30,LOW(100)
	LDI  R31,HIGH(100)
	__SUBWRR 3,4,30,31
; 0000 00AB             buttonCounter++;
_0xF:
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	__ADDWRR 5,6,30,31
...
; 0000 00AE           PORTD.5 = 0;
	CBI  0xB,5
; 0000 00AF           OCR1AL = pwmValue;
	STS  136,R3
; 0000 00B0 
; 0000 00B1           if(buttonCounter == 10)
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CP   R30,R5
	CPC  R31,R6
